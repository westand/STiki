/**************************************************************************/
/*                                                                        */
/* Andrew G. West - client_queue_fetch_stiki.sql - This is a stored proc  */
...
/*                                                                        */
/* This file handles the "STiki" queue (and the [queue_stiki] table)      */
/*                                                                        */
/**************************************************************************/

CREATE PROCEDURE client_queue_fetch_stiki
...
BEGIN
  ...
  DECLARE cur CURSOR FOR SELECT R_ID, P_ID FROM queue_stiki WHERE RES_ID=resid;
  ...
  INSERT INTO log_client 
    VALUES (SUBSTRING(USER(), 1, 128),'queue_fetch_stiki',UNIX_TIMESTAMP());
