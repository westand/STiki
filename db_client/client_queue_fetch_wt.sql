/**************************************************************************/
/*                                                                        */
/* Andrew G. West - client_queue_fetch_wt.sql - This is a stored proc     */
...
/*                                                                        */
/* This file handles the "WikiTrust" queue (and the [queue_wt] table)     */
/*                                                                        */
/**************************************************************************/

CREATE PROCEDURE client_queue_fetch_wt
...
BEGIN
  ...
  DECLARE cur CURSOR FOR SELECT R_ID, P_ID FROM queue_wt WHERE RES_ID=resid;
  ...
  INSERT INTO log_client 
    VALUES (SUBSTRING(USER(), 1, 128),'queue_fetch_wt',UNIX_TIMESTAMP());
